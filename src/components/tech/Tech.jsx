                    ...
                    <div className="items">
                        <div className="item">
                            ...
                            <div className="text">
                                ...
                                <a target="_blank" rel="noopener noreferrer" href="https://eko.com"> Learn more</a>
                            </div>
                        </div>
                        <div className="item">
                            ...
                            <div className="text">
                                ...
                                <a target="_blank" rel="noopener noreferrer" href="https://studio.eko.com"> Learn more</a>
                            </div>
                        </div>
                        <div className="item">
                            ...
                            <div className="text">
                                ...
                                <a  target="_blank" rel="noopener noreferrer" href="https://developer.eko.com"> Learn more</a>
                            </div>
                        </div>
                        <div className="item">
