...
import "./IFramily.scss";

import logoImage from './iframily_logo.png';
import iconSecurity from './icon_security.svg';
import iconComputers from './icon_computers.svg';
import iconConnection from './icon_connection.svg';
...
function IFramily(props){
    ...
    let codepenId = 'ZEBzaLd';

    return (
        <Fragment>
            <a href="https://github.com/EkoLabs/iframily" className="github-corner" aria-label="View source on GitHub">
            ...
            <Header/>
            <section className="osProject iframily">
                <div className="content">
                    <header>
                        <img src={logoImage} alt="iFramily Logo" title="iFramily"/>
                        <div className="text">
                            <h1>iFramily</h1>
                            <h2>iFramily simplifies working and establishing communication between iFrames. It provides a simpler API than postMessage, which includes Promise-based responses, message queuing, and holding on to messages until both frames are ready to talk.</h2>
                        </div>
                    </header>
                    <iframe scrolling="no" title="iFramily Example" className="codepen"
            ...
            <section className="menu">
                <ul className="content">
                    <li><a href="https://github.com/EkoLabs/iframily#examples">Examples</a></li>
                    <li><a href="https://github.com/EkoLabs/iframily">Docs</a></li>
                    <li><a href="https://github.com/EkoLabs/iframily/issues">Support</a></li>
                    <li><a href="https://github.com/EkoLabs/iframily#contributing">Contribute</a></li>
                </ul>
            </section>
