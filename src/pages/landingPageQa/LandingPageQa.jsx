        ...
        <div className="landingPageQa">
            ...
            <section className="splash">
                <div className="content">
                    ...
                    <div className="right">
                        <h3>If you’re a natural-born QA engineer who loves to understand how systems work, <em>let's talk.</em></h3>
                    </div>
                </div>
            </section>
            <section className="points">
                <div class="content">
                    ...
                    <ul>
                        ...
                        <li>Go beyond the spec and imagine the entire experience from the users' perspective</li>
                        <li>Provide critical insights and input throughout the product dev process</li>
                        <li>Design, develop and execute test scripts</li>
                        <li>Lead manual testing of new features in a complex environment</li>
